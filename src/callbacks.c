...
Voiture p;
input1=lookup_widget(objet,"entrymarque_voiture");
...
strcpy(p.marque,gtk_entry_get_text(GTK_ENTRY(input1)));
...
input111=lookup_widget(objet,"entrymarque_mod");
...
strcpy(m.modmarque,gtk_entry_get_text(GTK_ENTRY(input111)));
